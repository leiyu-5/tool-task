<template>
  <div class="has-sidebar flex min-h-screen bg-gray-50">
    <Sidebar :activeTab="activeTab" @change-tab="activeTab = $event" @logout="handleLogout" title="整机DPL" />
      ...
      <main class="main-content">
        <div class="header flex items-center justify-between mb-8">
          <div>
            ...
            <p class="text-gray-500 mt-1">欢迎回来，整机DPL管理员</p>
          </div>
...
const pendingTasks = ref([
  { id: 1, title: '完成整机主板测试', dueDate: '2024-01-15', skills: '硬件测试', hours: 8 },
  { id: 2, title: '更新BIOS固件', dueDate: '2024-01-16', skills: 'BIOS开发', hours: 4 },
  { id: 3, title: '优化散热系统', dueDate: '2024-01-14', skills: '散热设计', hours: 16 }
])

const inProgressTasks = ref([
  { id: 4, title: '调试电源模块', dueDate: '2024-01-18', assignee: '张三', progress: 60, originalSkills: '硬件测试', originalHours: 8 },
  { id: 5, title: '编写测试文档', dueDate: '2024-01-20', assignee: '李四', progress: 30, originalSkills: '文档编写', originalHours: 6 }
])

const completedTasks = ref([
  { id: 6, title: '初始化项目环境', assignee: '王五', completedDate: todayStr, dueDate: '2024-01-10', progress: 100, originalSkills: '环境配置', originalHours: 4 },
  { id: 7, title: '硬件选型确认', assignee: '赵六', completedDate: todayStr, dueDate: '2024-01-11', progress: 100, originalSkills: '硬件选型', originalHours: 4 }
])

const teamMembers = ref([
  { id: 1, name: '张三', role: '硬件工程师', avatar: '张', skills: ['硬件测试', '电路设计', 'PCB'], hours: 6 },
  { id: 2, name: '李四', role: '固件工程师', avatar: '李', skills: ['BIOS', 'UEFI', '驱动开发'], hours: 4 },
  { id: 3, name: '王五', role: '结构工程师', avatar: '王', skills: ['散热设计', '机械结构'], hours: 8 },
  { id: 4, name: '赵六', role: '测试工程师', avatar: '赵', skills: ['功能测试', '性能测试'], hours: 2 },
  { id: 5, name: '孙七', role: '项目经理', avatar: '孙', skills: ['项目管理', '需求分析'], hours: 3 }
])

const chartData = ref([
  { label: '周一', value: 60, count: 12 },
